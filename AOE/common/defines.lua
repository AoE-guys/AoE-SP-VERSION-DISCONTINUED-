...
country = {
	...
	PARTY_LOYALTY_HIT_ON_WAR_LOSS = 0.90, -- Drops the ruling party loyalty if war is lost.
...
diplomacy = {
	...
	BREAKTRUCE_PRESTIGE_ANNEX = -30,
	BREAKTRUCE_PRESTIGE_DEMAND_STATE = -30,
...
ai =
{
	...
	SOLDIER_FRACTION = 0.055, -- max amount of population AI wants to be soldiers
