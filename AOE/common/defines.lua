...
country = {
	...
	GOLD_TO_CASH_RATE = 0.02, -- Amount of money generated per gold unit
	...
	MIN_DELAY_BETWEEN_REFORMS = 15, -- months
	...
	POP_GROWTH_COUNTRY_CACHE_DAYS = 15, -- period of cached pop growth (used for player)
...
economy = {
	...
	GOODS_FOCUS_SWAP_CHANCE = 0.1, -- Percent increased chance that artisan wants to change goods independently of how well he is doing presently
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.45,	-- how fast pops are Hired when there is a high demand
	...
	EMPLOYMENT_HIRE_LOWEST = 0.02,				-- we Hire pops no slower then x% of total required per day
	EMPLOYMENT_FIRE_LOWEST = 0.02,				-- we Fire pops no slower then x% of total required per day
	...
	FACTORY_PURCHASE_MIN_FACTOR = 0.65,			-- the lowest % of its daily needs a factory will purchase
...
military = {
	...
	AI_ARMY_TAXBASE_FRACTION = 0.20, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
	AI_NAVY_TAXBASE_FRACTION = 0.20, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
...
diplomacy = {
	...
	PEACE_COST_CHANGE_HEIR_HABSBURG = 85,
	PEACE_COST_CHANGE_HEIR_BOURBON = 85,
	...
	INFAMY_COLONY = 5,
	INFAMY_CHANGE_HEIR_HABSBURG = 0,
	INFAMY_CHANGE_HEIR_BOURBON = 0,
	...
	PRESTIGE_CHANGE_HEIR_HABSBURG = 5,
	PRESTIGE_CHANGE_HEIR_BOURBON = 5,
	...
	PEACE_COST_CHANGE_HEIR_HABSBURG = 0.05,
	PEACE_COST_CHANGE_HEIR_BOURBON = 0.05,
	...
	PEACE_COST_CHANGE_HEIR_HABSBURG = 1,
	PEACE_COST_CHANGE_HEIR_BOURBON = 1,
	...
	BREAKTRUCE_PRESTIGE_CHANGE_HEIR_HABSBURG = -20,
	BREAKTRUCE_PRESTIGE_CHANGE_HEIR_BOURBON = -20,
	...
	BREAKTRUCE_MILITANCY_CHANGE_HEIR_HABSBURG = 2,
	BREAKTRUCE_MILITANCY_CHANGE_HEIR_BOURBON = 2,
	...
	GOODRELATION_INFAMY_CHANGE_HEIR_HABSBURG = 1,
	GOODRELATION_INFAMY_CHANGE_HEIR_BOURBON = 1,
	...
	GOODRELATION_PRESTIGE_CHANGE_HEIR_HABSBURG = -20,
	GOODRELATION_PRESTIGE_CHANGE_HEIR_BOURBON = -20,
	...
	GOODRELATION_MILITANCY_CHANGE_HEIR_HABSBURG = 2,
	GOODRELATION_MILITANCY_CHANGE_HEIR_BOURBON = 2,
