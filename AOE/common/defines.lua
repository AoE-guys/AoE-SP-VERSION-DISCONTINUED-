...
diplomacy = {
	...
	PEACE_COST_CHANGE_HEIR_HABSBURG_CB = 70,
	PEACE_COST_CHANGE_HEIR_BOURBON_CB = 70,
	...
	INFAMY_COLONY = 0,
	INFAMY_CHANGE_HEIR_HABSBURG_CB = 0,
	INFAMY_CHANGE_HEIR_BOURBON_CB = 0,
	...
	PRESTIGE_CHANGE_HEIR_HABSBURG_CB = 5,
	PRESTIGE_CHANGE_HEIR_BOURBON_CB = 5,
